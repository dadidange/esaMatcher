...
## <a name="Cld">func</a> [Cld](/src/target/esaMatcher.go?s=4262:4287#L170)
``` go
...
## <a name="Lcp">func</a> [Lcp](/src/target/esaMatcher.go?s=3205:3239#L129)
``` go
...
## <a name="RevComp">func</a> [RevComp](/src/target/esaMatcher.go?s=5176:5207#L213)
``` go
...
## <a name="RevCompObs">func</a> [RevCompObs](/src/target/esaMatcher.go?s=5746:5778#L245)
``` go
...
## <a name="Sa">func</a> [Sa](/src/target/esaMatcher.go?s=2561:2599#L107)
``` go
...
## <a name="Esa">type</a> [Esa](/src/target/esaMatcher.go?s=502:610#L27)
``` go
type Esa struct {
...
### <a name="NewEsa">func</a> [NewEsa](/src/target/esaMatcher.go?s=1209:1248#L48)
``` go
...
### <a name="NewRevEsa">func</a> [NewRevEsa](/src/target/esaMatcher.go?s=1553:1595#L64)
``` go
...
### <a name="Esa.Cld">func</a> (\*Esa) [Cld](/src/target/esaMatcher.go?s=828:853#L40)
``` go
func (e *Esa) Cld() []int
```
...
### <a name="Esa.GetInterval">func</a> (\*Esa) [GetInterval](/src/target/esaMatcher.go?s=10886:10947#L401)
``` go
...
### <a name="Esa.GetMatch">func</a> (\*Esa) [GetMatch](/src/target/esaMatcher.go?s=11887:11934#L441)
``` go
...
### <a name="Esa.Lcp">func</a> (\*Esa) [Lcp](/src/target/esaMatcher.go?s=745:770#L38)
``` go
func (e *Esa) Lcp() []int
```
...
### <a name="Esa.Print">func</a> (\*Esa) [Print](/src/target/esaMatcher.go?s=1754:1785#L73)
``` go
...
### <a name="Esa.Sa">func</a> (\*Esa) [Sa](/src/target/esaMatcher.go?s=647:671#L36)
``` go
func (e *Esa) Sa() []int
```
...
### <a name="Esa.Sequence">func</a> (\*Esa) [Sequence](/src/target/esaMatcher.go?s=913:944#L42)
``` go
...
### <a name="Esa.StrandSize">func</a> (\*Esa) [StrandSize](/src/target/esaMatcher.go?s=1090:1120#L45)
``` go
...
## <a name="EsaInterval">type</a> [EsaInterval](/src/target/esaMatcher.go?s=7996:8067#L331)
``` go
...
### <a name="EmptyEsaInterval">func</a> [EmptyEsaInterval](/src/target/esaMatcher.go?s=10198:10233#L386)
``` go
...
### <a name="NewEsaInterval">func</a> [NewEsaInterval](/src/target/esaMatcher.go?s=9761:9815#L366)
``` go
...
### <a name="EsaInterval.End">func</a> (\*EsaInterval) [End](/src/target/esaMatcher.go?s=8210:8240#L341)
``` go
...
### <a name="EsaInterval.L">func</a> (\*EsaInterval) [L](/src/target/esaMatcher.go?s=8397:8425#L345)
``` go
...
### <a name="EsaInterval.Mid">func</a> (\*EsaInterval) [Mid](/src/target/esaMatcher.go?s=8308:8338#L343)
``` go
...
### <a name="EsaInterval.Start">func</a> (\*EsaInterval) [Start](/src/target/esaMatcher.go?s=8116:8148#L339)
``` go
...
- - -
This file was autogenerated using [godoc2md](http://godoc.org/github.com/davecheney/godoc2md)
```
godoc2md github.com/dadidange/esaMatcher > README.md
```
